...
*	全国三级城市联动 js版
*/
var TempModel = require('./region.ejs');
...
function Region(modal) {
    modal.append(TempModel);
    var province = modal.find('#s_province');
    var city = modal.find('#s_city');
    var country = modal.find('#s_county');
    for (var i = 0; i < dsy.Items[0].length; i++) {
        var dom = $('<option value=' + '0_' + i + '>' + dsy.Items[0][i] + '</option>');
        dom.appendTo(province);
    }
    province.change(function () {
        city.html('<option value="a">市</option>');
        country.html('<option value="">县/区</option>');
        if ($(this).val() != 'a') {
            var cityVal = $(this).val();
            for (var i = 0; i < dsy.Items[cityVal].length; i++) {
                var dom = $('<option value=' + cityVal + '_' + i + '>' + dsy.Items[cityVal][i] + '</option>');
                dom.appendTo(city);
            }
        }
    });
    city.change(function () {
        ...
        if ($(this).val() != 'a') {
            ...
            for (var i = 0; i < dsy.Items[countryVal].length; i++) {
                var _dom = $('<option value=' + countryVal + '_' + i + '>' + dsy.Items[countryVal][i] + '</option>');
                _dom.appendTo(country);
            }
        }
    })
}
